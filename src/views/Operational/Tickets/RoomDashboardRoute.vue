<template>
  <RoomDashboard
    ...
    v-bind:favoritedRoom="favoritedRoom"
    v-bind:rooms="rooms"
    v-bind:roomsLoaded="roomsLoaded"
    v-bind:ticketInfo="ticketInfo"
    v-bind:doctors="doctors"
    v-bind:doctorsLoaded="doctorsLoaded"
    v-bind:sectorName="sectorName"
    v-bind:sector="sector"
    v-bind:doctorsListDialog="doctorsListDialog"
    v-bind:selectedRoom="selectedRoom"
    v-bind:room="room"
    v-bind:createRoomController="createRoomController"
