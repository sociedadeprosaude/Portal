                    ...
                    <v-card>
                        ...
                        >
                            ...
                            <template v-slot:item.tuesday="{ item }">
                                <br/>
                                <v-chip small class="font-weight-bold" dark label v-for="(index,i) in item.tuesday" :key="i"
                                        :color="i == '0' ? 'blue' : i == '1' ? 'green' : i == '2' ? 'red' : i == '3' ? 'purple' : i == '4' ? 'orange' : 'pink'"
                                >{{index}}</v-chip>
                                <br/><br/>
                            </template>
                            ...
                            <template v-slot:item.wednesday="{ item }">
                                <br/>
                                <v-chip small class="font-weight-bold" dark label v-for="(index,i) in item.wednesday" :key="i"
                                        :color="i == '0' ? 'blue' : i == '1' ? 'green' : i == '2' ? 'red' : i == '3' ? 'purple' : i == '4' ? 'orange' : 'pink'"
                                >{{index}}</v-chip>
                                <br/><br/>
                            </template>
...
/!*                console.log(arr)*!/
            ...
            doctorsMap2() {
                ...
                for (let i in arr) {
                    ...
                    for (let j in daysoftheweek) {
                        for (let k in array) {
                            if( daysoftheweek[j].hour === array[k].hour && j == '4'){
