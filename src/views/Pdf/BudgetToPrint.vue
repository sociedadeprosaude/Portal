                                  ...
                                  <v-flex xs12 class="text-right mr-4" v-if="budget.discount > 0">
                                    ...
                                    <v-flex xs6 class="text-left mt-12">
                                        <v-layout column wrap class="primary--text">
                                            ...
                                            <span v-if="this.selectedUnit.has_address"> {{this.selectedUnit.has_address[0].street + ' ' + selectedUnit.has_address[0].number +  ',' +  selectedUnit.has_address[0].neighboor}}</span>
                                            <span>Manaus - AM</span>
