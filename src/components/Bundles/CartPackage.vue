                            ...
                            <v-layout row wrap>
                                ...
                                <v-flex xs12 class="my-4">
                                    <v-layout row wrap>
                                        ...
                                        <v-flex xs6>
                                            <span>Valor Antigo: R$ {{this.subTotal.toLocaleString('en-us', {minimumFractionDigits: 2})}}</span>
                                        </v-flex>
                                        <v-flex xs6>
                                        ...
                                        <v-flex xs12>
                                            <h6 class="title font-weight-bold primary--text"> Novo Valor: R$
                                ...
                                <v-flex xs12>
                                    <v-layout row wrap class="align-end fill-height">
                                        <v-flex xs12 class="text-center">
                                            <submit-button
                                                    text="Salvar Pacote" :loading="paymentLoading" outlined
                                                    :success="paymentSuccess" color="primary" @click="validateRegister()">
                                            </submit-button>
                                        </v-flex>
                                        <v-flex xs5 class="text-center mt-4">
                                            <v-btn color="indigo darken-1" @click="clearCart()">Limpar Tudo</v-btn>
                                        </v-flex>
                                        <v-spacer></v-spacer>
                                        <v-flex xs5 class="text-center mt-4">
                                            <v-btn color="error" @click="deletePackage()">Excluir</v-btn>
                                        </v-flex>
                                    </v-layout>
                                </v-flex>
                            </v-layout>
