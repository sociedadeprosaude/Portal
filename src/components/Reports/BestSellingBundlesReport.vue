        ...
        <v-card id="card-to-print" flat style="border: 10px solid #F5F5F5; background-color: #F5F5F5">
            ...
            <div v-if="optionSelected === 0">
                <v-data-table
                        :headers="headers"
                        :search="search"
                        :items="BundlesFormatArray"
                        :sort-by="['quantity']"
                        :sort-desc="[true]"
                        item-key="name"
                        no-data-text="Sem pacotes no intervalo escolhido"
                        :footer-props="{
      itemsPerPageText:'Pacotes por página',
      pageText:'{0}-{1} de {2}'
    }"
                >
                </v-data-table>
                ...
                <v-row>
                    <v-col>
                        <v-card class="primary align-center text-center pt-4" style="height: 100px; border-radius: 10px" flat>
                            ...
                            <br/>
                            <span class="background--text">Total de pacotes vendidos</span>
                        </v-card>
                    </v-col>
                    <v-col>
                        <v-card class="primary align-center text-center pt-4" style="height: 100px; border-radius: 10px" flat>
                            ...
                            <br/>
                            <span class="background--text">Custo total dos pacotes</span>
                        </v-card>
                    </v-col>
                    <v-col>
                        <v-card class="primary align-center text-center pt-4" style="height: 100px; border-radius: 10px" flat>
                            ...
                            <br/>
                            <span class="background--text">Preço de venda total dos pacotes</span>
                        </v-card>
                    </v-col>
                    <v-col>
                        <v-card class="primary align-center text-center pt-4" style="height: 100px; border-radius: 10px" flat>
