                        ...
                        >
                            ...
                            >
                                <v-layout row wrap>
                                    ...
                                    <v-flex xs1>
                                        <ApolloQuery
                                                v-if="product.with_product && product.with_clinic && product.with_product.type === 'EXAM' "
                                        ...
                                        >
                                            <template v-slot="{result: {data, loading, error}}">
                                                <v-flex v-if="data">{{data.CostProductClinic[0].cost | moneyFilter}}
                                                </v-flex>
                            ...
                            <v-layout row wrap>
                                ...
                                <v-flex xs12 class="my-1">
                                    <v-layout row wrap>
                                        ...
                                        <v-flex xs2>{{payments.dinheiro ? payments.dinheiro : 'X' | moneyFilter}}
                                        </v-flex>
                                        <v-flex xs1>
                                            <v-divider vertical/>
                                        </v-flex>
