                                        ...
                                        <v-layout column wrap>
                                            ...
                                            <div >
                                                <v-flex>
                                                    ...
                                                    <span class="font-weight-bold">{{ this.consultation.product.type === 'EXAM' ? 'Exame' : 'Consulta' }}</span>
                                                </v-flex>
                                                <v-flex>
                                                    <span class="primary--text font-weight-bold">{{ this.consultation.product.type === 'EXAM' ? 'Exame' : 'Consulta' }}: </span>
