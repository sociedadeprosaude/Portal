<template>
    <v-container class="ma-0 pa-0">
        ...
        <v-app-bar
                ...
                v-if="selectedUnit"
        >
            <v-app-bar-nav-icon v-if="doctorsAgendaToobar || billsToobar || RegistersToobar"
                ...
                <v-row align="end" justify="end">
                    <v-col cols="12">
                        <v-btn rounded text @click="selectUnit()"
                               v-if="user.type !== 'clinic' && user.group === 'admin'">
        ...
        >
            ...
            <v-toolbar-title class="ma-0 pa-0">
                <router-link to="/" tag="span" style="cursor: pointer">
                    <v-img v-if="selectedUnit" :src="selectedUnit.logo" aspect-radio="1" width="100"/>
                </router-link>
            </v-toolbar-title>
            <v-spacer/>
            <v-toolbar-items>
