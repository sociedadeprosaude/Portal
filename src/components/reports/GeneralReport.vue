                    ...
                    <v-layout row wrap>
                        ...
                        <v-flex xs12>
                            <v-layout row wrap class="mt-2">
                                ...
                                <v-flex xs1>
                                    <span v-if="totalSpecialtiesIntakes > 0">{{((totalSpecialtiesIntakes - totalCostSpecialtiesIntakes) / totalSpecialtiesIntakes) * 100 | moneyFilter}}%</span>
                                    <span v-else>0%</span>
                                </v-flex>
                                <v-flex xs1>
                                    <v-divider vertical></v-divider>
                        ...
                        <v-flex xs12>
                            <v-layout row wrap class="mt-2">
                                ...
                                <v-flex xs1>
                                    <span v-if="totalExamsIntakes > 0">{{((totalExamsIntakes - totalCostExamsIntakes) / totalExamsIntakes) * 100 | moneyFilter}}%</span>
                                    <span v-else>0%</span>
                                </v-flex>
                                <v-flex xs1>
                                    <v-divider vertical></v-divider>
            ...
            <v-flex xs12  v-if="reportSelected === 2 || reportSelected === 3">
                <v-card class="pa-4 receipt-to-print">
                    <v-layout row wrap>
                        ...
                        <v-flex xs12 v-for="(spec, label) in reportAllUnits.specialties" :key="label" class="my-1">
                            <v-layout row wrap>
                                <v-flex xs12>
                                    <v-divider></v-divider>
                                </v-flex>
                        ...
                        <v-flex xs12>
                            <v-layout row wrap class="mt-2">
                                ...
                                <v-flex xs1>
                                    {{totalCostSpecialtiesIntakesAllClinics | moneyFilter}}
                                </v-flex>
                                <v-flex xs1>
                                    <v-divider vertical></v-divider>
                                </v-flex>
                                <v-flex xs1>
                                    {{totalSpecialtiesIntakesAllClinics | moneyFilter}}
                                </v-flex>
                                <v-flex xs1>
                                    <v-divider vertical></v-divider>
                                </v-flex>
                                <v-flex xs1>
                                    <span v-if="totalSpecialtiesIntakesAllClinics > 0">{{((totalSpecialtiesIntakesAllClinics - totalCostSpecialtiesIntakesAllClinics) / totalSpecialtiesIntakesAllClinics) * 100 | moneyFilter}}%</span>
                                    <span v-else>0%</span>
                                </v-flex>
                                <v-flex xs1>
                                    <v-divider vertical></v-divider>
                        ...
                        <v-flex xs12 v-for="(clinics, label) in reportAllUnits.clinics" :key="label" class="my-1">
                            <v-layout row wrap>
                                <v-flex xs12>
                                    <v-divider></v-divider>
                                </v-flex>
                        ...
                        <v-flex xs12>
                            <v-layout row wrap class="mt-2">
                                ...
                                <v-flex xs1>
                                    {{totalCostExamsIntakesAllClinics | moneyFilter}}
                                </v-flex>
                                <v-flex xs1>
                                    <v-divider vertical></v-divider>
                                </v-flex>
                                <v-flex xs1>
                                    {{totalExamsIntakesAllClinics | moneyFilter}}
                                </v-flex>
                                <v-flex xs1>
                                    <v-divider vertical></v-divider>
                                </v-flex>
                                <v-flex xs1>
                                    <span v-if="totalExamsIntakesAllClinics > 0">{{((totalExamsIntakesAllClinics- totalCostExamsIntakesAllClinics) / totalExamsIntakesAllClinics) * 100 | moneyFilter}}%</span>
                                    <span v-else>0%</span>
                                </v-flex>
                                <v-flex xs1>
                                    <v-divider vertical></v-divider>
                        ...
                        <v-flex xs12>
                            <v-layout row wrap class="mt-2">
                                ...
                                <v-flex xs2>
                                    {{totalOuttakesInMoneyAllClinics + totalOuttakesNotMoneyAllClinics | moneyFilter}}
                                </v-flex>
                                <v-flex xs1>
                                    <v-divider vertical></v-divider>
                                </v-flex>
                        ...
                        <v-flex xs12 class="mt-2">
                            <v-layout row wrap v-if="reportAllUnits.financialSupportIntakes.length > 0">
                                ...
                                <v-flex xs12 v-for="intake in reportAllUnits.financialSupportIntakes" :key="intake.date"
                                        class="my-1">
                                    <v-layout row wrap>
                                        <v-flex xs12>
                                            <v-divider></v-divider>
                        ...
                        <v-flex xs12>
                            <v-layout row wrap>
                                        ...
                                        <v-flex xs11>
                                            <v-layout row wrap>
                                                <v-flex xs12>
                                                    <v-layout row wrap>
                                                        <v-flex xs2 class="border">Saldo Bruto</v-flex>
                                                        <v-flex xs3 class="border">{{totalCreditAllClinics | moneyFilter}}
                                                        </v-flex>
                                                        <v-flex xs3 class="border">{{totalDebitAllClinics | moneyFilter}}
                                                        </v-flex>
                                                        <v-flex xs3 class="border">{{totalMoneyAllClinics +
                                            ...
                                            <v-layout row wrap>
                                                <v-flex xs12>
                                                    <v-layout row wrap>
                                                        ...
                                                        <v-flex xs3 class="border">{{totalCostSpecialtiesIntakesAllClinics |
                                                            moneyFilter}}
                                                        </v-flex>
                                                        <v-flex xs1 class="border">
                                                ...
                                                <v-flex xs12>
                                                    <v-layout row wrap>
                                                        ...
                                                        <v-flex xs3 class="border">{{totalCostExamsIntakesAllClinics |
                                                            moneyFilter}}
                                                        </v-flex>
                                                        <v-flex xs1 class="border">
                                                ...
                                                <v-flex xs12>
                                                    <v-layout row wrap>
                                                        <v-flex xs2 class="border">Gastos Op. (dia-a-dia)</v-flex>
                                                        <v-flex xs3 class="border">{{0 | moneyFilter}}</v-flex>
                                                        <v-flex xs3 class="border">{{this.totalOuttakesNotMoneyAllClinics |
                                                            moneyFilter}}
                                                        </v-flex>
                                                        <v-flex xs3 class="border">{{this.totalOuttakesInMoneyAllClinics |
                                                            moneyFilter}}
                                                        </v-flex>
                                                        <v-flex xs1 class="border">
                                                ...
                                                <v-flex xs12>
                                                    <v-layout row wrap>
                                                        <v-flex xs2 class="border">Taxas do cartão</v-flex>
                                                        <v-flex xs3 class="border">{{parseFloat(totalTaxaCreditAllClinics)
                                                            | moneyFilter}}
                                                        </v-flex>
                                                        <v-flex xs3 class="border">{{parseFloat(totalTaxaDebitAllClinics)
                                                            | moneyFilter}}
                                                        </v-flex>
                                                        <v-flex xs3 class="border">{{0 | moneyFilter}}
                                                        </v-flex>
                                                ...
                                                <v-flex xs12>
                                                    <v-layout row wrap>
                                                        ...
                                                        <v-flex xs3 class="border">{{ totalOuttakesNotMoneyAllClinics |
                                                            moneyFilter}}
                                                        </v-flex>
                                                        <v-flex xs3 class="border">{{totalCostSpecialtiesIntakesAllClinics +
                                            ...
                                            <v-layout row wrap>
                                                <v-flex xs12>
                                                    <v-layout row wrap>
                                                        ...
                                                        <v-flex xs3 class="border">{{totalCreditAllClinics -
                                                            parseFloat(totalTaxaCreditAllClinics) | moneyFilter}}
                                                        </v-flex>
                                                        <v-flex xs3 class="border">{{totalDebitAllClinics -
                                ...
                                <v-flex xs12 class="my-1">
                                    <v-layout row wrap class="justify-center">
                                        <v-flex xs3 class="border">
                                            {{ this.totalRawIntakeAllClinics | moneyFilter}}
                                        </v-flex>
                                        <v-flex xs3 class="border">
    ...
    export default {
        ...
        data() {
            return {
                ...
                total: 0,
                reportOptions: ['Relatório Geral', 'Relatório Geral Detalhado', 'Relatório Geral de Todas Unidades', 'Relatório Geral de Todas Unidades Detalhado'],
                reportSelected: 0
            }
        },
        computed: {
            ...
            finalProfitAllClinics() {
                return (parseFloat(this.totalProfitAllClinics) - parseFloat(this.totalCostAllClinics)).toFixed(2)
            },
            totalProfitAllClinics(){
                return (parseFloat(this.totalSpecialtiesIntakesAllClinics)+ parseFloat(this.totalExamsIntakesAllClinics) + parseFloat(this.totalFinancialSupportAllClinics))
            },
            totalCostAllClinics() {
                return (parseFloat(this.totalCostSpecialtiesIntakesAllClinics)+ parseFloat(this.totalCostExamsIntakesAllClinics) +
                    parseFloat(this.totalTaxaDebitAllClinics) + parseFloat(this.totalTaxaCreditAllClinics) +
                    parseFloat(this.totalOuttakesInMoneyAllClinics) + parseFloat(this.totalOuttakesNotMoneyAllClinics))
            },
            ...
            totalRawIntakeAllClinics() {
                return this.reportAllUnits.intakesArray.reduce((sum, intake) => sum + parseFloat(intake.total), 0)
            },
            totalCreditAllClinics() {
                return this.reportAllUnits.intakesArray.reduce((sum, intake) => {
                    for (let payment in intake.payments) {
