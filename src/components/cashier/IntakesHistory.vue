  ...
  <v-app>
    <v-card>
      ...
      <v-container class="my-0">
        <v-layout row wrap>
          <v-flex xs12>
            <span class="my-headline" style="font-size: 1.3em">Histórico</span>
          </v-flex>
          <v-flex xs12>
            <v-btn-toggle v-model="option" tile color="primary accent-3" group mandatory>
              <v-btn value="intakes">Vendas</v-btn>
              <v-btn value="budgets">Orçamentos</v-btn>
            </v-btn-toggle>
          </v-flex>
