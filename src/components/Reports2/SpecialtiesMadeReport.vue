          ...
          <v-layout row wrap>
            ...
            <v-flex xs12>
              <v-layout row wrap class="mt-2">
                ...
                <v-flex xs4>Médico</v-flex>
                <v-flex xs1>
                  <v-divider vertical></v-divider>
                </v-flex>
                <v-flex xs2>Quantidade</v-flex>
                <v-flex xs1>
                  <v-divider vertical></v-divider>
                </v-flex>
            ...
            <v-flex xs12 v-for="(doctor, label) in report.doctors" :key="label" class="my-1">
              <v-layout row wrap>
                ...
                <v-flex xs2>{{doctor.quantityTotal}}</v-flex>
                <v-flex xs1>
                  <v-divider vertical></v-divider>
                </v-flex>
                <v-flex xs2>{{doctor.payment | moneyFilter}}</v-flex>
                <v-flex xs1>
                  <v-divider vertical></v-divider>
                </v-flex>
                <v-flex xs1>
                ...
                <v-flex xs12 class="mt-4" v-if="reportSelected === 1">
                  <v-layout row wrap v-for="(specialties, name) in doctor.specialties" :key="name">
                    ...
                    <v-flex xs2>{{specialties.quantity}}</v-flex>
                    <v-flex xs1>
                      <v-divider vertical></v-divider>
                    </v-flex>
                    <v-flex xs2>{{specialties.cost | moneyFilter}}</v-flex>
                    <v-flex xs1>
                      <v-divider vertical></v-divider>
                    </v-flex>
                    <v-flex xs1>
            ...
            <v-flex xs12>
              <v-layout row wrap class="mt-2">
                ...
                <v-flex xs2>{{QuantityTotal }}</v-flex>
                <v-flex xs1>
                  <v-divider vertical></v-divider>
                </v-flex>
                <v-flex xs2>{{CostTotal | moneyFilter}}</v-flex>
                <v-flex xs1>
                  <v-divider vertical></v-divider>
                </v-flex>
                <v-flex xs12>
